...
$sql2.=" order by C_export.id_car  ASC  LIMIT ".$sf.",10";
		...
		<section class="container sbl clearfix">
			...
			<section id="content" class="two-thirds column">
				...
				<div class="page-header clearfix">
					...
					<h3 class="section-title">Export Vechicles</h3>
				...
				?>
					...
					<article>
						...
						<a href="car_detail.php?car_id=<?=$car_id?>&table=export" class="single-image picture">
						...
						<div class="detailed">
							...
							<a href="car_detail.php?car_id=<?=$car_id?>&table=export" class="button orange">Details</a>
				...
				if($model){$sql2 .= "and (C_export.model LIKE '%$model%' ) ";}
				if($category){$sql2 .= "and C_export.id_car_make=".$category." ";}
				$sql2.=" order by C_export.id_car  ASC  ";
					$count_pg=$eg->get_data($sql2);
			            ...
			            for($i = 1; $i <= $tp; $i++)
			            {
			                ...
			                echo "<a class='page'  href='export.php?page=".$i."'>".$i."</a> ";
